#!/bin/bash
#PBS -l select=4:ncpus=6:mem=8gb -l place=scatter:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_4_6_scatter-excl.out
#PBS -e output/tests/ht_4_6_scatter-excl.err
...
PARAM_DIR="HPC/tests/t_4_6_scatter-excl"
