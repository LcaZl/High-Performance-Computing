#!/bin/bash
#PBS -l select=6:ncpus=4:mem=8gb -l place=scatter
#PBS -l walltime=0:50:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_4_6_scatter.out
#PBS -e output/tests/ht_4_6_scatter.err
...
PARAM_DIR="HPC/tests/t_4_6_scatter"
