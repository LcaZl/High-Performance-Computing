#!/bin/bash
#PBS -l select=1:ncpus=8:mem=8gb -l place=scatter
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_1_8_scatter.out
#PBS -e output/tests/ht_1_8_scatter.err
...
PARAM_DIR="HPC/tests/t_1_8_scatter"
