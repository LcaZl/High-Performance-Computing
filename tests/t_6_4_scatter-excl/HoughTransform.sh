#!/bin/bash
#PBS -l select=6:ncpus=4:mem=8gb -l place=scatter:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_6_4_scatter-excl.out
#PBS -e output/tests/ht_6_4_scatter-excl.err
...
PARAM_DIR="HPC/tests/t_6_4_scatter-excl"
