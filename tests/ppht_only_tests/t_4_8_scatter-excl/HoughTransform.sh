#!/bin/bash
#PBS -l select=4:ncpus=8:mem=8gb -l place=scatter:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_4_8_scatter-excl.out
#PBS -e output/tests/ht_4_8_scatter-excl.err
...
PARAM_DIR="HPC/tests/ppht_only_tests/t_4_8_scatter-excl"

for PARAM_FILE in $PARAM_DIR/parameters_*; do

    # Set environment variables
    export PBS_SELECT=4
    export PBS_NCPUS=32 # (select * cpus) -> total number of cpus.
    export PBS_MEM=8
