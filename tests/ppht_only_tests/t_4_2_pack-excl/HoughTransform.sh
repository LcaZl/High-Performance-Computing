#!/bin/bash
#PBS -l select=4:ncpus=2:mem=8gb -l place=pack:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_4_2_pack-excl.out
#PBS -e output/tests/ht_4_2_pack-excl.err
...
PARAM_DIR="HPC/tests/ppht_only_tests/t_4_2_pack-excl"
