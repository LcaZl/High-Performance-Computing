#!/bin/bash
#PBS -l select=3:ncpus=8:mem=8gb -l place=pack:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_3_8_pack-excl.out
#PBS -e output/tests/ht_3_8_pack-excl.err
...
PARAM_DIR="HPC/tests/ppht_only_tests/t_3_8_pack-excl"
