#!/bin/bash
#PBS -l select=2:ncpus=4:mem=8gb -l place=pack:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_2_4_pack-excl.out
#PBS -e output/tests/ht_2_4_pack-excl.err
...
PARAM_DIR="HPC/tests/ppht_only_tests/t_2_4_pack-excl"
