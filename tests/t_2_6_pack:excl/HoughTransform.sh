#!/bin/bash
#PBS -l select=2:ncpus=6:mem=8gb -l place=pack:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_2_6_pack:excl.out
#PBS -e output/tests/ht_2_6_pack:excl.err
...
PARAM_DIR="HPC/tests/t_2_6_pack:excl"
