#!/bin/bash
#PBS -l select=8:ncpus=2:mem=8gb -l place=pack:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_8_2_pack-excl.out
#PBS -e output/tests/ht_8_2_pack-excl.err
...
PARAM_DIR="HPC/tests/t_8_2_pack-excl"
