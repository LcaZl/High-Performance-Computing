#!/bin/bash
#PBS -l select=8:ncpus=4:mem=8gb -l place=scatter:excl
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_8_4_scatter-excl.out
#PBS -e output/tests/ht_8_4_scatter-excl.err
...
PARAM_DIR="HPC/tests/t_8_4_scatter-excl"
