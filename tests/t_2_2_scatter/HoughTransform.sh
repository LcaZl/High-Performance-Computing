#!/bin/bash
#PBS -l select=2:ncpus=2:mem=8gb -l place=scatter
#PBS -l walltime=3:00:00
#PBS -N ja_tests_hts
#PBS -q short_cpuQ
#PBS -o output/tests/ht_2_2_scatter.out
#PBS -e output/tests/ht_2_2_scatter.err
...
PARAM_DIR="HPC/tests/t_2_2_scatter"
