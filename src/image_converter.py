...
def convert_image(input_image_path, output_format):
    ...
    """
    if is_directory(input_image_path):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert an image or all images in a directory to a specified format without specifying the initial format.")
